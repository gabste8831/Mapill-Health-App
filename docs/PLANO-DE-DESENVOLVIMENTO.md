...
> **Rodada de 26/08.** A primeira execução completa aconteceu; os achados estão em
> [`REVISAO-2026-08-26.md`](./REVISAO-2026-08-26.md). Passaram os itens **1 a 13, 16, 17, 19 a 22
> e 29 a 37**; o **7** (relógio nativo, o de maior risco) abre e funciona, com ressalva de
> usabilidade. Falharam ou ficaram bloqueados: **24, 25 e 28**, todos por causa do F1 — sem dose
> gerada não há o que confirmar, descontar ou alertar. **Retestar depois das correções de 26/08**,
...
| 2026-08-26 | Revisão | Concluído | **Revisão do app em aparelho, bloco a bloco, organizada em [`REVISAO-2026-08-26.md`](./REVISAO-2026-08-26.md).** 37 achados classificados em funcionalidade (F), experiência (X) e escopo novo (E), cada um com código próprio, gravidade e o que decidir. Oito blocos passaram sem ressalva; só o 17 não passou. Confirmações que o teste trouxe: o relógio nativo dentro do `Modal` abre e funciona (era o item de maior risco da fila §6.2), horário duplicado é barrado, e o login com Google e o fluxo de conta funcionaram por completo. |
