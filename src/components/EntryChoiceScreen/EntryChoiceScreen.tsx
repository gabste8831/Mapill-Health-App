...
import { styles } from "./EntryChoiceScreen.styles";

export type EntryChoiceOption = {
  label: string;
 ...
 */
export function EntryChoiceScreen({ title, options }: EntryChoiceScreenProps) {
  return (
