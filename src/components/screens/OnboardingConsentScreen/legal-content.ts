 ...
 * OnboardingConsentScreen, entre o login e a ficha de saúde (ver decisão de onboarding em
...
export const APP_PURPOSE_TEXT =
  ...
  "compromissos de saúde organizados em um só lugar. Ele funciona mesmo sem internet, e " +
  "os seus dados ficam salvos no seu aparelho por padrão. Saiba mais sobre como usamos seus dados em Termos de Uso e Política de Privacidade.";
...
export const TERMS_OF_USE_SECTIONS: LegalSection[] = [
  {
    ...
    paragraphs: [
      "O Mapill é um aplicativo de apoio à rotina terapêutica, desenvolvido como Trabalho de " +
        ...
        "compromissos de saúde (consultas, exames, renovação de receita).",
