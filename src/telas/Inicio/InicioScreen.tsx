  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <CardProximaDose time="14:30" medicationLabel="Metformina 500mg (1 comprimido)" hint="Tomar com bastante água durante o almoço" />
        ...
        <CardEstoqueBaixo medicationName="Lisinopril" daysRemaining={4} />
        ...
        <CardAdesaoSemanal days={MOCK_WEEKLY_ADHERENCE} summary="Adesão de 100% mantida nesta semana." />
      </ScrollView>
