...
type CapsulaDoMapillProps = {
   ...
   * desenho passa a ser branco-sobre-claro, que e como a marca aparece no icone do app.
   */
  sobreAzul?: boolean;
...
/**
 * So a capsula do lockup, sem a palavra.
 *
